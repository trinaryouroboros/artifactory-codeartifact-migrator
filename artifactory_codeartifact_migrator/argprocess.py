...
def getArgs():
    ...
    parser.add_argument(
        "--dryrun", help="Perform dry run operations only", action="store_true"
    )
    parser.add_argument(
        "--cache", help="Use cache mode for rerun performance", action="store_true"
    )
    parser.add_argument(
        "--dynamodb", help="Use dynamodb for cache", action="store_true"
    )
    parser.add_argument(
        "--refresh",
    ...
    parser.add_argument(
        "--clean", help="Wipe the entire cache and start over", action="store_true"
    )
    parser.add_argument(
        "-p",
        "--procs",
    ...
    parser.add_argument("-o", "--output", help="Output to a file (defaults to stdout)")
    parser.add_argument(
        "--artifactoryhost", help="Artifactory host name", required=True
    )
    parser.add_argument(
        "--artifactoryprefix",
    ...
    parser.add_argument(
        "--artifactoryuser", help="Artifactory user name", required=True
    )
    parser.add_argument(
        "--artifactorypass", help="Artifactory password or api key", required=True
    )
    parser.add_argument(
        "--codeartifactdomain", help="Codeartifact domain", required=True
    )
    parser.add_argument(
        "--codeartifactaccount", help="Codeartifact account ID", required=True
    )
    parser.add_argument(
        "--codeartifactregion", help="Codeartifact region", required=True
    )
    parser.add_argument(
        "--repositories",
